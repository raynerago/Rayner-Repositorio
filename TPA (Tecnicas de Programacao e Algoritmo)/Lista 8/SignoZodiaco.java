...
public class SignoZodiaco {
		...
		public static void main(String[] args) {
			...
			System.out.println("Digite o numero do seu mês de nascimento:");
			mes=Ler.nextInt();
			System.out.println("Digite o numero do dia de seu nascimento:");
			dia=Ler.nextInt();
			...
			default:
				System.out.println("Mês incompativel");
